      ...
      <ConstraintedBox classNames="p-4 pb-16 pt-8 sm:pt-16">
        <WrappedBox classes="justify-items-stretch">
          <Column classes="justify-center">
            ...
            <p className="max-w-sm font-semibold">{About.designation}</p>

            <p className="max-w-full mt-8 sm:max-w-sm md:max-w-md lg:max-w-lg">
              {About.description}
            </p>
                ...
                {socialLinks.map((link, index) => {
                  return (
                    <Link
                      ...
                      href={link.url}
                      target="_blank"
                      className="p-3 app__icon_btn lg:p-4"
